...
let ExcelController = class ExcelController {
    constructor(_excelService) {
        this._excelService = _excelService;
    }
    async writeDailyReport(data, res) {
        const wb = await this._excelService.loadTemplate(data);
...
], ExcelController.prototype, "writeDailyReport", null);
ExcelController = __decorate([
    common_1.Controller('excel'),
